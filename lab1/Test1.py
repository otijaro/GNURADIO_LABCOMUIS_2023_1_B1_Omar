...
class Test1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Sample_frequency", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Sample_frequency")
        ...
        # Blocks
        ##################################################
        self._frequency_range = Range(-samp_rate/2, samp_rate/2, 100, 50, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, frequency, 5, 0, 0)
